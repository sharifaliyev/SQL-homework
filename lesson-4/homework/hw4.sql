...
1.Select top 5 employees from Employees table
SELECT TOP 5 * 
FROM Employees;
  
2.  Select unique Category values from Products table
...
7.  Replace NULL values in Email with “noemail@example.com
”
SELECT EmployeeID,
       ISNULL(Email, 'noemail@example.com') AS Email
FROM Employees;

8.  Show products with Price BETWEEN 50 AND 100
SELECT * 
FROM Products
WHERE Price BETWEEN 50 AND 100;

9.  DISTINCT on two columns (Category and ProductName)
SELECT DISTINCT Category, ProductName
FROM Products;

10. DISTINCT on two columns ordered by ProductName descending
SELECT DISTINCT Category, ProductName
FROM Products
...
2.COALESCE: return first non-null of FirstName or LastName
SELECT EmployeeID,
...
4..Employees age between 30–40 OR department = 'Marketing'
SELECT *
FROM Employees
WHERE (Age BETWEEN 30 AND 40)
   OR DepartmentName = 'Marketing';

5..Select rows 11 to 20 ordered by Salary (DESC)
SELECT *
FROM Employees
ORDER BY Salary DESC
OFFSET 10 ROWS FETCH NEXT 10 ROWS ONLY;

6.  Products with Price ≤ 1000 and StockQuantity > 50, sorted by Stock ascending
SELECT *
FROM Products
WHERE Price <= 1000 AND StockQuantity > 50
ORDER BY StockQuantity ASC;

7. Products with ProductName containing letter 'e'
SELECT *
FROM Products
